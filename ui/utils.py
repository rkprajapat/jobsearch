...
def truncate_text(text: str, max_length: int = CONTENT["description_preview_length"]) -> tuple[str, bool]:
    """
...
class DescriptionToggle:
    ...
    def __init__(self, full_text: str, max_length: int = CONTENT["description_preview_length"]):
    ...
    def get_button_label(self) -> str:
        ...
        return CONTENT["button_show_less"] if self.is_expanded else CONTENT["button_show_more"]
